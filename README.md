...
Adax-Tool is a Python-based multitool for automating and processing various tasks.  
It is designed to be simple to use and works on both Windows and Linux/macOS systems.
...
Just double klick on Adax_MultiTool.py
